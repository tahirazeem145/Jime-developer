...
export default function Testimonials() {
  ...
  return (
    <section id="testimonials" className="relative w-full bg-transparent pt-6 pb-6 sm:pt-8 sm:pb-8 px-4 sm:px-6 lg:px-8 overflow-hidden select-none border-t border-slate-200/80">
