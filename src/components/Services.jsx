  ...
  const services = [
    {
      ...
      glowColor: 'rgba(167, 243, 160, 0.18)',
    },
    {
      id: 'ecommerce',
      category: 'ecommerce',
      ...
      glowColor: 'rgba(144, 230, 136, 0.18)',
    },
    {
      id: 'mobile-app',
      category: 'mobile',
      ...
      glowColor: 'rgba(167, 243, 160, 0.16)',
    },
    {
      id: 'saas-cloud',
      category: 'saas',
      ...
      glowColor: 'rgba(167, 243, 160, 0.2)',
    }
  ];
  ...
  return (
    <section id="services" className="relative z-10 py-20 sm:py-28 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 mb-16 sm:mb-20">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.id}
                className="group relative rounded-3xl bg-[#101712]/90 backdrop-blur-xl border border-[#1D2E22] hover:border-accent-lime/40 transition-all duration-500 overflow-hidden flex flex-col justify-between hover:shadow-[0_12px_40px_rgba(0,0,0,0.6),0_0_30px_rgba(167,243,160,0.1)] hover:-translate-y-1"
              >
                {/* Top Subtle Ambient Card Gradient */}
                <div 
                  className={`absolute top-0 left-0 right-0 h-40 bg-gradient-to-b ${service.gradient} opacity-50 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`} 
                />

                {/* Card Corner Index Indicator */}
                <div className="absolute top-6 right-6 font-sora font-bold text-xs text-muted-text/30 group-hover:text-accent-lime/50 transition-colors">
                  0{index + 1}
                </div>
                ...
                <div className="relative p-6 sm:p-8 md:p-9 z-10">
                  ...
                  <div className="flex items-center justify-between gap-4 mb-6">
                    ...
                    <span className="px-3 py-1 rounded-full text-xs font-inter font-medium text-accent-lime bg-[#1A2E1F]/60 border border-[#2E4A35] backdrop-blur-sm">
                      {service.badge}
                    </span>
                  </div>
                  ...
                  <p className="font-inter text-xs sm:text-sm font-medium text-accent-lime/80 mt-1 mb-4">
                    {service.tagline}
                  </p>

                  {/* Description */}
                  <p className="text-sm sm:text-[15px] text-muted-text font-inter leading-relaxed mb-6">
                    {service.description}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-2 pt-2">
                    {service.techStack.map((tech) => (
                      <span 
                        key={tech} 
                        className="text-[11px] font-inter font-medium px-2.5 py-1 rounded-md bg-[#131D16] border border-[#1D2E22] text-muted-text group-hover:border-[#2E4A35] transition-colors"
                      >
                        {tech}
                      </span>
                    ))}
                ...
                {/* Card Action Footer */}
                <div className="relative px-6 sm:px-8 py-4 bg-[#0D140F]/90 border-t border-[#1D2E22] flex items-center justify-between z-10 group-hover:bg-[#121E15]/90 transition-colors duration-300">
                  <a
                    href={service.href}
                    target="_blank"
        ...
        <div className="rounded-3xl bg-[#101712]/70 border border-[#1D2E22] p-6 sm:p-10 mb-16 backdrop-blur-md">
