...
export default function MouseGlow() {
  ...
  return (
    ...
    >
      {/* Outer Ambient Electric Blue / Sapphire Soft Glow */}
      <div
        ref={outerGlowRef}
        ...
        style={{
          width: '550px',
          height: '550px',
          background: 'radial-gradient(circle, rgba(59, 130, 246, 0.12) 0%, rgba(30, 58, 138, 0.18) 45%, transparent 70%)',
          filter: 'blur(50px)',
        }}
      />

      {/* Inner Subtle Electric Blue Core Glow */}
      <div
        ref={innerGlowRef}
        className="absolute top-0 left-0 rounded-full pointer-events-none will-change-transform"
        style={{
          width: '240px',
          height: '240px',
          background: 'radial-gradient(circle, rgba(59, 130, 246, 0.18) 0%, rgba(96, 165, 250, 0.05) 50%, transparent 80%)',
          filter: 'blur(30px)',
        }}
      />
    </div>
